...
For exporting resistance_surfaces, we should...

For exporting gdist.response, we can...

The gdist.response information is very straightforward to access as it just needs to be printed to a file.

resistance_surfaces is a RasterStack, but we also know how it can be separated into the three layers. In order to access it outside of R, we need to...